    ...
    <section className='bg-neutral-900 fixed top-0 bottom-0 right-0 left-0 bg-opacity-70 z-50'>
        <div className='bg-white w-full max-w-sm min-h-screen max-h-screen ml-auto'>
                ...
                {/***display items */}
                {
                    cartItem[0] ? (
                        ...
                        <div className='bg-white flex flex-col justify-center items-center'>
                            ...
                            />
                            <Link onClick={close} to={"/"} className='block bg-[#2cb8cb] px-4 py-2 text-white rounded'>Shop Now</Link>
                        </div>
                    )
                }
...

            {
                cartItem[0] && (
                    <div className='p-2'>
                        <div className='bg-[#2cb8cb] text-neutral-100 px-4 font-bold text-base py-4 static bottom-3 rounded flex items-center gap-4 justify-between'>
                            <div>
